...
#include <assert.h>
#if defined(_WIN32)
typedef INT_PTR (WINAPI * PFNWGLGETPROCADDRESSPROC)(LPCSTR);
void* GalogenGetProcAddress(const char *name) {
  ...
  static PFNWGLGETPROCADDRESSPROC wgl_get_proc_address = NULL;
  if (!wgl_get_proc_address) {
    ...
    wgl_get_proc_address = (PFNWGLGETPROCADDRESSPROC)GetProcAddress(opengl32module, "wglGetProcAddress");
