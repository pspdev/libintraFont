				...
				{ //scrolling (any direction) requested
					...
					{ //scrolling really required
						...
						case INTRAFONT_SCROLL_LEFT:							   //scroll left
							sceGuScissor(left - 2, 0, column + 4, 272); //limit to column width
							if (count < 60)
							{
						...
						case INTRAFONT_SCROLL_SEESAW:											//scroll left and right
							sceGuScissor(left - column / 2 - 2, 0, column / 2 + 4, 272); //limit to column width
							textwidth -= column;
							if (count < 60)
							{
						...
						case INTRAFONT_SCROLL_RIGHT:						   //scroll right
							sceGuScissor(left - column - 2, 0, 4, 272); //limit to column width
							if (count < 60)
							{
